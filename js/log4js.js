 ...
 */
Log.prototype.debug     = function(s) { if (this.getLevel()<=Log.DEBUG) { this._log(arguments,"DEBUG",this); } }
/**
 * Log an event with priority of "info"
 * @param s the log message
 */
Log.prototype.info      = function(s) { if (this.getLevel()<=Log.INFO ) { this._log(arguments,"INFO",this); } }
/**
 * Log an event with priority of "warn"
 * @param s the log message
 */
Log.prototype.warn      = function(s) { if (this.getLevel()<=Log.WARN ) { this._log(arguments,"WARN",this); } }
/**
 * Log an event with priority of "error"
 * @param s the log message
 */
Log.prototype.error     = function(s) { if (this.getLevel()<=Log.ERROR) { this._log(arguments,"ERROR",this); } }
/**
 * Log an event with priority of "fatal"
 * @param s the log message
 */
Log.prototype.fatal     = function(s) { if (this.getLevel()<=Log.FATAL) { this._log(arguments,"FATAL",this); } }
...
Log.consoleLogger = function(msg,level,obj) {
    if (window.console) {
        switch (level) {
        case "DEBUG":
            window.console.debug.apply(window.console, msg);
            break;
        case "INFO":
            window.console.info.apply(window.console, msg);
            break;
        case "WARN":
            window.console.warn.apply(window.console, msg);
            break;
        case "ERROR":
            window.console.error.apply(window.console, msg);
            break;
        default:
