...
visualivr.Toolbar = Class.extend({
	...
	init:function(elementId, view){ 
		...
		this.deleteButton.button().click($.proxy(function(){
		  ...
		  if (eval(node.isDeleteable()) == true)
		  {
		...
		// Inject the DELETE Button
		//
		this.workspaceButton  = $("<button>Workspace Size</button>");
		this.workspaceButton.css({position:"absolute", right: "30px"});
		this.html.append(this.workspaceButton);
		$(this.workspaceButton).click(function(e) {
